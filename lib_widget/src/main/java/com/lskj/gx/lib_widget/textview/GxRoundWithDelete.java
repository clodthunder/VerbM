 ...
 * new ImageEntity(UUID.randomUUID().toString(), null, String.valueOf(R.drawable.temp)));
...
public class GxRoundWithDelete extends RelativeLayout {
  ...
  private void init(AttributeSet attrs) {
    ...
    realImage.setId(R.id.gx_round_with_delete_real_image);
    ...
    delImage.setId(R.id.gx_round_with_delete_del_image);
    ...
    RelativeLayout.LayoutParams delParentParams = (LayoutParams) delImage.getLayoutParams();
  ...
  public interface OnRealImageClick {
    void onRealImgClick(GxRoundImgView realImg, ImageEntity imageEntity);
  ...
  public void setImgEntity(ImageEntity imgEntity) {
