...
import com.lskj.gx.lib_basic_base.BaseOnClickListener;
import com.lskj.gx.lib_basic_base.ImageEntity;
import com.lskj.gx.lib_widget.R;
 ...
 * 2种模式：1 编辑模式 2 查看模式
 */
public class HoriImages extends HorizontalScrollView {
  ...
  public HoriImages(Context context) {
    super(context);
    init(context, null);
  }

  public HoriImages(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public HoriImages(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public void init(Context context, AttributeSet attrs) {
    ...
    ImageEntity temp = new ImageEntity(UUID.randomUUID().toString(), null, String.valueOf(R.drawable.temp));
    ImageEntity temp2 = new ImageEntity(UUID.randomUUID().toString(), null, String.valueOf(R.drawable.temp2));
    ImageEntity temp3 = new ImageEntity(UUID.randomUUID().toString(), null, String.valueOf(R.drawable.temp3));
    ImageEntity temp4 = new ImageEntity(UUID.randomUUID().toString(), null, String.valueOf(R.drawable.temp4));
    ImageEntity temp5 = new ImageEntity(UUID.randomUUID().toString(), null, String.valueOf(R.drawable.temp));
    ...
    setHorIvClickListener(new OnHorIvClickListener() {
      @Override public void OnHorIvClick(int position, ImageEntity entity, GxRoundImgView iv) {
  ...
  private GxRoundImgView createImgView(int i, ImageEntity entity) {
    ...
    temp.setOnClickListener(new BaseOnClickListener() {
      @Override public void onMultiClick(View v) {
  ...
  public class HorIvItemClick implements OnClickListener {
    ...
    public HorIvItemClick(int position, GxRoundImgView iv, ImageEntity entity) {
  ...
  public interface OnHorIvClickListener {
    public void OnHorIvClick(int position, ImageEntity entity, GxRoundImgView iv);
  }
}
