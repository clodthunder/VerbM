package com.lskj.gx.lib_basic_img.trans;
 ...
 * 指定四边任意角度
 */
public final class RoundForCorners extends BitmapTransformation {
   ...
   */
  public RoundForCorners(int leftTopRadius, int rightTopRadius, int leftBottomRadius, int rightBottomRadius) {
  ...
  protected Bitmap transform(@NonNull BitmapPool pool, @NonNull Bitmap toTransform, int outWidth, int outHeight) {
    return RoundForCornersUtils.roundedCorners(pool, toTransform, leftTopRadius, rightTopRadius, leftBottomRadius,
        rightBottomRadius);
  }

  @Override public boolean equals(Object o) {
    if (o instanceof RoundForCorners) {
      RoundForCorners other = (RoundForCorners) o;
      return (leftTopRadius == other.leftTopRadius) && (rightTopRadius == other.rightTopRadius) && (leftBottomRadius
          == other.leftBottomRadius) && (rightBottomRadius == other.rightBottomRadius);
    }
    return false;
  }

  @Override public int hashCode() {
    return Util.hashCode(ID.hashCode(), Util.hashCode(leftTopRadius,
        Util.hashCode(rightTopRadius, Util.hashCode(leftBottomRadius, Util.hashCode(rightBottomRadius)))));
  }
