...
public class VoiceTalkActivity extends AppCompatActivity
    implements View.OnClickListener, HikVideoPlayerCallback.VoiceTalkCallback {
  private static final String TAG = "VoiceTalkActivity";
  protected ProgressBar progressBar;
  protected TextView playHintText;
  protected EditText reviewUriEdit;
  private String mUri = "rtsp://39.96.32.210:554/openUrl/BkjaFKo";
   ...
   */
  @Override public void onTalkStatus(@NonNull HikVideoPlayerCallback.Status status, int errorCode) {
