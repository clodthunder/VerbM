package com.lskj.gx.lib_hk_video.widget;
...
import com.lskj.gx.lib_hk_video.MyUtils;
import com.lskj.gx.lib_hk_video.R;
        ...
        switchScreenImage.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (ScreenUtils.isPortrait()){
                    ...
                    switchScreenImage.setImageResource(R.drawable.hk_minimum_white_nor_24);
                }else if (ScreenUtils.isLandscape()){
                    //切换到竖屏
                    MyUtils.getActivity(AutoHideView.this).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                    switchScreenImage.setImageResource(R.drawable.hk_maximum_white_nor_24);
                }
                resetHideTask();
            }
        });
